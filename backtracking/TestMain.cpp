...
int main() {
	...
	test_cases.push_back(test_generateTrees);
	func_names.push_back("test_generateTrees");
	test_cases.push_back(test_removeInvalidParentheses);
	func_names.push_back("test_removeInvalidParentheses");
