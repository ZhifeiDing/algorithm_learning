...
int main() {
	...
	test_cases.push_back(test_isSelfCrossing);
	func_names.push_back("test_isSelfCrossing");
	test_cases.push_back(test_generate);
	func_names.push_back("test_generate");
	test_cases.push_back(test_grayCode);
	func_names.push_back("test_grayCode");
	...
	test_cases.push_back(test_isPowerOfFour);
	func_names.push_back("test_isPowerOfFour");
